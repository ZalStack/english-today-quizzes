        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
            <div class="p-4 sm:p-8">
                ...
                @if($attempt->quiz->show_score)
                    <div class="bg-gradient-to-r from-blue-600 to-blue-500 rounded-2xl p-4 sm:p-8 mb-6 sm:mb-8 text-white text-center">
                ...
                <div class="flex flex-col sm:flex-row justify-center gap-3 sm:gap-4 mt-6 sm:mt-8">
                    <a href="{{ route('employee.dashboard') }}"
                       class="w-full sm:w-auto px-4 sm:px-8 py-2.5 sm:py-3 bg-gradient-to-r from-blue-600 to-blue-500 text-white rounded-xl hover:shadow-lg transition-all duration-300 font-bold text-center text-sm sm:text-base">
                        Back to Dashboard
                    </a>
