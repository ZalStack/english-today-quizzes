    ...
    <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
            <div class="px-4 sm:px-8 py-4 sm:py-6 bg-gradient-to-r from-indigo-600 to-purple-600">
                ...
                <p class="text-indigo-100 text-sm mt-1">Enter the enrollment key to start your assessment</p>
            </div>
                ...
                <form action="{{ route('employee.quizzes.enroll') }}" method="POST" class="space-y-4 sm:space-y-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="enroll_key" id="enroll_key"
                            ...
                            class="w-full px-3 sm:px-4 py-2.5 sm:py-3 rounded-xl border border-gray-300 focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition text-center text-xl sm:text-2xl font-bold tracking-widest uppercase"
