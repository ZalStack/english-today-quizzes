...
<div class="py-12">
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6">
                <h2 class="text-2xl font-bold text-gray-900 mb-6">Create Employee Account</h2>
                ...
                <form action="{{ route('hr.employees.store') }}" method="POST">
                    ...
                    <div class="flex justify-end space-x-3 mt-6">
                        <a href="{{ route('hr.employees.index') }}" class="px-4 py-2 bg-gray-300 text-gray-700 rounded-lg hover:bg-gray-400 transition">
                            Cancel
                        </a>
