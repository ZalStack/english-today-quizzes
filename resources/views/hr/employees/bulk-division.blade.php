...
@section('content')
<div class="mb-4">
    <a href="{{ route('hr.employees.index') }}" class="text-indigo-600 hover:text-indigo-700 text-sm font-semibold inline-flex items-center gap-1">
...
<div class="hr-card overflow-hidden">
    <form action="{{ route('hr.employees.bulk.division.update') }}" method="POST">
        ...
        <div class="px-6 py-4 border-t border-slate-100 flex flex-col sm:flex-row justify-between items-center gap-3">
