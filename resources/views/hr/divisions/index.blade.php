...
<div class="py-4 sm:py-6 lg:py-8">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 sm:mb-8 gap-3 sm:gap-0">
            <div>
                <h1 class="text-2xl sm:text-3xl font-extrabold text-gray-900">Divisions</h1>
                <p class="text-gray-500 text-sm sm:text-base mt-1">Manage company departments and teams</p>
            </div>
            <a href="{{ route('hr.divisions.create') }}" class="w-full sm:w-auto inline-flex items-center justify-center px-4 sm:px-6 py-2.5 sm:py-3 bg-gradient-to-r from-indigo-600 to-purple-600 text-white rounded-xl hover:shadow-lg transition-all duration-300 font-medium text-sm sm:text-base">
            ...
            <div class="table-responsive">
                <table class="min-w-full divide-y divide-gray-200">
                    <thead class="bg-gray-50">
                        <tr>
                            <th class="px-3 sm:px-6 py-3 sm:py-4 text-left text-[10px] sm:text-xs font-semibold text-gray-500 uppercase tracking-wider">Division</th>
                            ...
                            <th class="px-3 sm:px-6 py-3 sm:py-4 text-left text-[10px] sm:text-xs font-semibold text-gray-500 uppercase tracking-wider">Employees</th>
                            ...
                            <tr class="hover:bg-gray-50 transition">
                                <td class="px-3 sm:px-6 py-3 sm:py-4">
                                    <div class="flex items-center space-x-2 sm:space-x-3">
                                        ...
                                        <span class="font-semibold text-gray-900 text-sm">{{ $division->name }}</span>
                                    </div>
                                </td>
                                <td class="hidden sm:table-cell px-3 sm:px-6 py-3 sm:py-4 text-gray-600 text-sm">{{ $division->description ?? '-' }}</td>
                                <td class="px-3 sm:px-6 py-3 sm:py-4 text-sm font-bold text-gray-900">{{ $division->users_count }}</td>
                        ...
                        @empty
                            <tr>
                                <td colspan="4" class="px-3 sm:px-6 py-8 sm:py-12 text-center">
                                    ...
                                    <p class="text-gray-500 font-medium text-sm sm:text-base">No divisions yet</p>
                                </td>
                            </tr>
                        @endforelse
                    </tbody>
