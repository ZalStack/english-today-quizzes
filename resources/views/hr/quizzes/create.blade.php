...
<div class="max-w-4xl">
    <div class="hr-card overflow-hidden">
        <form action="{{ route('hr.quizzes.store') }}" method="POST" enctype="multipart/form-data" class="p-6 sm:p-8 space-y-5">
            @csrf
            ...
            <div class="flex flex-col sm:flex-row justify-end gap-3 pt-4 border-t border-slate-100">
                ...
                <button type="submit" class="hr-btn-primary">Create Quiz</button>
            </div>
        </form>
    </div>
</div>
