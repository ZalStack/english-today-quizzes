...
<div class="py-4 sm:py-6 lg:py-8">
    <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
            ...
            <!-- Profile Update -->
            <form action="{{ route('hr.profile.update') }}" method="POST" class="p-4 sm:p-8 space-y-4 sm:space-y-6 border-b border-gray-200">
                @csrf
                @method('PUT')
            ...
            <!-- Password Update -->
            <form action="{{ route('hr.profile.password') }}" method="POST" class="p-4 sm:p-8 space-y-4 sm:space-y-6">
                @csrf
                @method('PUT')
