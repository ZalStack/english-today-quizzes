                    ...
                    <div class="bg-blue-50 border border-blue-200 rounded-xl p-5">
                        ...
                        <div class="text-sm text-blue-800 space-y-3">
                            ...
                            <div class="bg-white p-4 rounded-lg border border-blue-200">
                                <pre class="text-xs overflow-x-auto whitespace-pre-wrap text-gray-700">PG
...
JAWAB: False</pre>
                            ...
                            <div>
                                <p class="font-semibold mb-2">Header tipe soal yang didukung:</p>
                                <div class="grid grid-cols-2 gap-2 text-xs">
                                    <div class="bg-white px-3 py-2 rounded border"><code>PG</code> atau <code>PILIHAN GANDA</code></div>
                                    <div class="bg-white px-3 py-2 rounded border"><code>JAWABAN SINGKAT</code> atau <code>ISIAN</code></div>
                                    <div class="bg-white px-3 py-2 rounded border"><code>BENAR SALAH</code> atau <code>TRUE FALSE</code></div>
                                    <div class="bg-white px-3 py-2 rounded border"><code>ESSAY</code> atau <code>URAIAN</code></div>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div id="dropZone" class="border-2 border-dashed border-gray-300 rounded-xl p-8 text-center hover:border-indigo-500 hover:bg-indigo-50/30 transition cursor-pointer">
                            ...
                            <label for="pdf_file" class="cursor-pointer block">
                                ...
                                <p class="text-gray-600 font-medium">Klik untuk upload atau drag & drop PDF</p>
                                <p class="text-sm text-gray-400 mt-1">Maksimal 10MB</p>
                            </label>
                            <p id="file-name" class="mt-3 text-indigo-600 font-medium hidden"></p>
                        </div>
                        @error('pdf_file')
